    ...
    def __init__(self, gcn_true, buildA_true, gcn_depth, num_nodes, device, predefined_A=None, static_feat=None, dropout=0.3, subgraph_size=10, node_dim=16, dilation_exponential=1, conv_channels=32, residual_channels=32, skip_channels=64, end_channels=128, seq_length=12, in_dim=2, out_dim=12, layers=1, propalpha=0.05, tanhalpha=3, layer_norm_affline=True, per_batch_adj=False, is_classifier=False):
        ...
        for i in range(1):
            ...
            for j in range(1,layers+1):
                ...
                if self.gcn_true:
                    self.gconv1.append(mixprop(self.gconv_channel_size_lst[j-1], self.gconv_channel_size_lst[j], gcn_depth, dropout, propalpha))
                    self.gconv2.append(mixprop(self.gconv_channel_size_lst[j-1], self.gconv_channel_size_lst[j], gcn_depth, dropout, propalpha))
